              ...
              >
                <div>
                  ...
                  <p className="text-neutral-400">
                    I typically respond within 24 hours. Tell me a bit about
                    yourself!
                  </p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <textarea
                      ...
                      placeholder={
                        persona === 'recruiter'
                          ? 'Hi Garv, I have a role that matches your skills...'
                          : 'Hey, I saw your work and...'
                      }
                    />
                  </div>
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-neutral-400 max-w-sm mx-auto">
                    Thanks for reaching out, {formData.name}. I've received your
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div className="group p-4 bg-white/5 rounded-xl border border-white/5 hover:border-white/10 transition-colors">
                    ...
                    <p className="text-sm text-neutral-400 mb-3 break-all">
                      garvak23@gmail.com
                    </p>
                    <button
                      onClick={copyEmail}
              ...
              <div>
                ...
                <div className="flex gap-3">
                  <a
                    ...
                    target="_blank"
                    className="p-3 bg-white/5 rounded-lg hover:bg-white/10 hover:text-white text-neutral-400 transition-colors"
                  >
                    <Github className="w-5 h-5" />
                  </a>
                  <a
                    href="https://www.linkedin.com/in/garv-akolia-40052a24a/"
                    target="_blank"
                    className="p-3 bg-white/5 rounded-lg hover:bg-[#0077b5]/20 hover:text-[#0077b5] text-neutral-400 transition-colors"
                  >
